...
def get_db():
    db = SessionLocal()
    try:
        yield db            #return gibi farkı return tek değer döndürüyor yield birden fazla iterator yapıp döndürebiliyor
    finally:
        db.close()

db_dependency = Annotated[Session, Depends(get_db)]
user_dependency = Annotated[dict, Depends(get_current_user)]   #başa fonksiyon ne döndürüyorsa onu ekle
